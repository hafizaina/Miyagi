...
public class DrawableGameShape : BaseDrawableGamePiece
{
    ...
    /// <returns>
    /// </returns>
    public DrawableGameShape(SpriteBatch sharedSprite, string NameOfShape, int widthOfThisGamePiece, int heightOfGamePiece, float xPos, float yPos, float zPos)
    {
        this.NameOfShape = NameOfShape;
        this.TextureForShape 
